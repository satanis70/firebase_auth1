...
public class Main2Activity extends AppCompatActivity implements RewardedVideoAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdRequest request = new AdRequest.Builder()
                .addTestDevice("90D252872AFC52A50DC82217EAD606E6")  // An example device ID
                .build();
        ...
        MobileAds.initialize(this, "ca-app-pub-6015294152911442~1501686762");

        mRewardedVideoAd = MobileAds.getRewardedVideoAdInstance(this);
        mRewardedVideoAd.setRewardedVideoAdListener(this);

        mRewardedVideoAd.loadAd("ca-app-pub-6015294152911442/7271819934",
